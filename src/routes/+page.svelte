...
>
	<div class="font-serif text-2xl tracking-tight text-slate-800">Data Artistry</div>
	<div class="hidden items-center gap-12 md:flex">
		<a
			class="font-serif text-lg text-slate-600 italic transition-opacity duration-300 hover:text-blue-500 hover:opacity-80"
			href="#">Home</a
		>
		<a
			class="font-serif text-lg text-slate-600 italic transition-opacity duration-300 hover:text-blue-500 hover:opacity-80"
		...
		>
		<a
			class="border-b-2 border-blue-600/30 font-serif text-lg font-bold text-blue-700 italic"
			href="#">About</a
		>
		<a
			class="font-serif text-lg text-slate-600 italic transition-opacity duration-300 hover:text-blue-500 hover:opacity-80"
	...
	<section class="relative mx-auto max-w-[1440px] px-12">
		...
		<div class="relative mb-40 grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-32">
			<div class="order-2 lg:order-1">
				<div class="group relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
					<img
						class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
						data-alt="Vintage university library with tall wooden shelves and a single focused student"
		...
		<div class="relative mb-40 grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-32">
			<div class="relative text-right lg:pr-12">
				...
				<div class="flex justify-end gap-4">
					...
					<div class="bg-secondary-container/30 rounded-lg p-3">
						<span class="material-symbols-outlined text-secondary" data-icon="data_exploration"
							>data_exploration</span
						>
					</div>
				</div>
			</div>
			<div>
				<div class="group relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
					<img
						class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
						data-alt="Abstract network of glowing blue nodes and connecting lines representing big data scale"
		...
		<!-- Chapter 3: Amsterdam Calling -->
		<div class="relative mb-40 grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-32">
			<div class="order-2 lg:order-1">
				<div class="group relative aspect-square overflow-hidden rounded-2xl shadow-2xl">
					<img
						class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
						data-alt="A foggy morning over an Amsterdam canal with bicycles parked on a bridge"
			...
			<div class="relative order-1 lg:order-2 lg:pl-12">
				...
				<div class="flex gap-4">
					<div class="bg-tertiary-container/30 rounded-lg p-3">
						<span class="material-symbols-outlined text-tertiary" data-icon="location_city"
							>location_city</span
						>
					</div>
					<div>
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
				<div class="space-y-6">
					<div class="aspect-[3/4] overflow-hidden rounded-xl shadow-lg">
						<img
							...
							data-alt="A close up of a vintage camera on a wooden table"
				...
				<div class="space-y-6 pt-12 md:pt-24">
					<div class="aspect-[3/4] overflow-hidden rounded-xl shadow-lg">
						<img
							class="h-full w-full object-cover"
							data-alt="A collection of diverse books on a shelf with a small plant"
				...
				<div class="space-y-6 pt-12 md:pt-0">
					<div class="aspect-[3/4] overflow-hidden rounded-xl shadow-lg">
						<img
							class="h-full w-full object-cover"
							data-alt="Hands holding a bicycle handlebar riding through a park"
	...
	<section class="relative mx-auto max-w-[1440px] px-12 py-40 text-center">
		...
		<div class="absolute inset-0 -z-10 opacity-5">
			<img
				...
				data-alt="Soft atmospheric texture"
...
<footer class="w-full border-t border-slate-100 bg-slate-50 px-12 py-20">
	...
	>
		<div class="font-serif text-lg text-slate-700 italic">Data Artistry</div>
		<div class="font-sans text-sm tracking-wide text-slate-500 uppercase">
			© 2024 Emna | Amsterdam-based Data Analytics.
		</div>
		<div class="flex gap-8">
			<a
				class="font-sans text-sm tracking-wide text-slate-500 uppercase transition-colors duration-500 hover:text-blue-500"
				href="#">LinkedIn</a
			>
			<a
				class="font-sans text-sm tracking-wide text-slate-500 uppercase transition-colors duration-500 hover:text-blue-500"
